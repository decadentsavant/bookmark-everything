...
The first launch seeds a few sample bookmarks so you can see each type in
action: your home and Downloads folders, this project on GitHub, the author on
X, and one installed application. Edit or delete them as you like. The `zz`
entry is the built-in help and is always there.
